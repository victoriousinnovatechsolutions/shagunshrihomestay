...
<ul>
    ...
    <li>
        ...
        <section className="gt-room-section fix section-padding section-bg">
            <div className="container">
            ...
            <div className="gt-room-wrapper">
                <div className="swiper gt-room-slider">
                    <div className="swiper-wrapper">
                        <div className="swiper-slide">
                            <div className="gt-room-box-items style-margin">
                                <div className="gt-thumb">
                                    <img src="assets/img/home-1/room/room-01.jpg" alt="img" />
                                    <img src="assets/img/home-1/room/room-01.jpg" alt="img" />
                                    <span className="gt-post-box">
                                        $269 / NIGHT
                                    </span>
                                </div>
                                <div className="gt-content">
                                <a href="/" className="gt-post-cat">Comfortable Room</a>
                                <h3><a href="/">Idustry Experience</a></h3>
                                ...
                                <a href="/" className="gt-link-btn">DISCOVER MORE</a>
                                </div>
                            </div>
                        </div>
                        <div className="swiper-slide">
                            <div className="gt-room-box-items">
                                <div className="gt-thumb">
                                    <img src="assets/img/home-1/room/room-02.jpg" alt="img" />
                                    <img src="assets/img/home-1/room/room-02.jpg" alt="img" />
                                    <span className="gt-post-box">
                                        $269 / NIGHT
                                    </span>
                                ...
                                <div className="gt-content">
                                <a href="/" className="gt-post-cat">Comfortable Room</a>
                                <h3><a href="/">Oceanview Deluxe Room</a></h3>
                                <ul className="gt-list">
                                        <li>
                                            <i className="flaticon-bed-1"></i>
                                            1500 SQ.FT/Rooms
                        ...
                        <div className="swiper-slide">
                            <div className="gt-room-box-items style-margin">
                                <div className="gt-thumb">
                                    <img src="assets/img/home-1/room/room-03.jpg" alt="img" />
                                    <img src="assets/img/home-1/room/room-03.jpg" alt="img" />
                                    <span className="gt-post-box">
                                        $269 / NIGHT
                                    </span>
                                ...
                                <div className="gt-content">
                                <a href="/" className="gt-post-cat">Comfortable Room</a>
                                <h3><a href="/">Look Our Comfortable Rooms</a></h3>
                                <ul className="gt-list">
                                        <li>
                                            <i className="flaticon-bed-1"></i>
                                            1500 SQ.FT/Rooms
                        ...
                        <div className="swiper-slide">
                            <div className="gt-room-box-items">
                                <div className="gt-thumb">
                                    <img src="assets/img/home-1/room/room-04.jpg" alt="img" />
                                    <img src="assets/img/home-1/room/room-04.jpg" alt="img" />
                                    <span className="gt-post-box">
                                        $269 / NIGHT
                                    </span>
                                ...
                                <div className="gt-content">
                                <a href="/" className="gt-post-cat">Comfortable Room</a>
                                <h3><a href="/">Comfortable Signature Suites</a></h3>
                                <ul className="gt-list">
                                        <li>
                                            <i className="flaticon-bed-1"></i>
                                            1500 SQ.FT/Rooms
                        ...
                        <div className="swiper-slide">
                            <div className="gt-room-box-items style-margin">
                                <div className="gt-thumb">
                                    <img src="assets/img/home-1/room/room-05.jpg" alt="img" />
                                    <img src="assets/img/home-1/room/room-05.jpg" alt="img" />
                                    <span className="gt-post-box">
                                        $269 / NIGHT
                                    </span>
                                ...
                                <div className="gt-content">
                                <a href="/" className="gt-post-cat">Comfortable Room</a>
                                <h3><a href="/">Delux Family Room</a></h3>
                                <ul className="gt-list">
                                        <li>
                                            <i className="flaticon-bed-1"></i>
                                            1500 SQ.FT/Rooms
                ...
                <div className="gt-booking-reserve-wrapper">
                    ...
                    <form action="#">
                        <div className="row">
                            ...
                            <div className="col-xl-12 wow fadeInUp" data-wow-delay=".8s">
                                <div className="form-clt">
                                    <button className="gt-theme-btn w-100" type="submit">SEARCH NOW</button>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <section className="gt-special-offer-section fix section-padding">
            <div className="gt-right-shape">
                <img src="assets/img/home-1/special-offer/right-shape.png" alt="img" />
            </div>
            <div className="container">
                <div className="gt-section-title text-center">
                    <h6 className="justify-content-center wow fadeInUp">
            ...
            <div className="gt-special-offer-wrapper">
                <div className="swiper gt-special-offer-slider">
                    <div className="swiper-wrapper">
                        <div className="swiper-slide">
                            <div className="gt-special-offer-box-items">
                                <div className="gt-thumb">
                                    <img src="assets/img/home-1/special-offer/offer-01.jpg" alt="img" />
                                    <img src="assets/img/home-1/special-offer/offer-01.jpg" alt="img" />
                                </div>
                                <div className="gt-content">
                                    <span>Experience Services</span>
                                    <h3><a href="/">Family Fun Package</a></h3>
                                    <p>Escape with your loved one and enjoy a luxury suite, champagne on arrival</p>
                                    <div className="gt-list-area">
                                        <ul className="gt-list">
                                            <li>
                                                <i className="flaticon-arrow-right"></i>
                        ...
                        <div className="swiper-slide">
                            <div className="gt-special-offer-box-items">
                                <div className="gt-thumb">
                                    <img src="assets/img/home-1/special-offer/offer-02.jpg" alt="img" />
                                    <img src="assets/img/home-1/special-offer/offer-02.jpg" alt="img" />
                                </div>
                                <div className="gt-content">
                                    <span>Experience Services</span>
                        ...
                        <div className="swiper-slide">
                            <div className="gt-special-offer-box-items">
                                <div className="gt-thumb">
                                    <img src="assets/img/home-1/special-offer/offer-03.jpg" alt="img" />
                                    <img src="assets/img/home-1/special-offer/offer-03.jpg" alt="img" />
                                </div>
                                <div className="gt-content">
                                    <span>Relaxation</span>
                                    <h3><a href="/">SPA & Beauty Center</a></h3>
                                    <p>Escape with your loved one and enjoy a luxury suite, champagne on arrival</p>
                                    <div className="gt-list-area">
                                        <ul className="gt-list">
                                            <li>
        ...
        {/* GT News Section Start */}
        <section className="gt-news-section section-padding pt-0">
            <div className="gt-right-shape">
        ...
        <div className="gt-instagram-section section-padding pb-0 fix section-bg">
            <div className="container">
                <div className="gt-section-title text-center">
                    <h6 className="justify-content-center wow fadeInUp">
                        <img src="assets/img/arrow-left.svg" alt="img" />
